...
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "parity-report" -d 'Compare two QA suite summaries and write an agentic parity gate report'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "telegram" -d 'Run the manual Telegram live QA lane against a private bot-to-bot group harness'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "matrix" -d 'Run the Docker-backed Matrix live QA lane against a disposable homeserver'
...
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "credentials" -d 'Manage pooled Convex live credentials used by QA lanes'
...
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l runner -d 'Execution runner: host or multipass'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l transport -d 'QA transport id'
...
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l cli-auth-mode -d 'CLI backend auth mode for live Claude CLI runs: auto, api-key, or subscription'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l parity-pack -d 'Preset scenario pack; currently only "agentic" is supported'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l scenario -d 'Run only the named QA scenario (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l concurrency -d 'Scenario worker concurrency'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l fast -d 'Enable provider fast mode where supported'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l image -d 'Multipass image alias'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l cpus -d 'Multipass vCPU count'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l memory -d 'Multipass memory size'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l disk -d 'Multipass disk size'
complete -c openclaw -n "__fish_seen_subcommand_from parity-report" -l candidate-summary -d 'Candidate qa-suite-summary.json path'
complete -c openclaw -n "__fish_seen_subcommand_from parity-report" -l baseline-summary -d 'Baseline qa-suite-summary.json path'
complete -c openclaw -n "__fish_seen_subcommand_from parity-report" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from parity-report" -l candidate-label -d 'Candidate display label'
complete -c openclaw -n "__fish_seen_subcommand_from parity-report" -l baseline-label -d 'Baseline display label'
complete -c openclaw -n "__fish_seen_subcommand_from parity-report" -l output-dir -d 'Artifact directory for the parity report'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l output-dir -d 'Telegram QA artifact directory'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l provider-mode -d 'Provider mode: mock-openai or live-frontier (legacy live-openai still works)'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l model -d 'Primary provider/model ref'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l alt-model -d 'Alternate provider/model ref'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l scenario -d 'Run only the named Telegram QA scenario (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l fast -d 'Enable provider fast mode where supported'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l sut-account -d 'Temporary Telegram account id inside the QA gateway config'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l credential-source -d 'Credential source for live lanes: env or convex (default: env)'
complete -c openclaw -n "__fish_seen_subcommand_from telegram" -l credential-role -d 'Credential role for convex auth: maintainer or ci (default: maintainer)'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l output-dir -d 'Matrix QA artifact directory'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l provider-mode -d 'Provider mode: mock-openai or live-frontier (legacy live-openai still works)'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l model -d 'Primary provider/model ref'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l alt-model -d 'Alternate provider/model ref'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l scenario -d 'Run only the named Matrix QA scenario (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l fast -d 'Enable provider fast mode where supported'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l sut-account -d 'Temporary Matrix account id inside the QA gateway config'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l credential-source -d 'Credential source for live lanes: env or convex (default: env)'
complete -c openclaw -n "__fish_seen_subcommand_from matrix" -l credential-role -d 'Credential role for convex auth: maintainer or ci (default: maintainer)'
...
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l transport -d 'QA transport id'
...
complete -c openclaw -n "__fish_seen_subcommand_from credentials" -a "add" -d 'Add one credential payload to the shared pool'
complete -c openclaw -n "__fish_seen_subcommand_from credentials" -a "remove" -d 'Remove one credential from active use by disabling it'
complete -c openclaw -n "__fish_seen_subcommand_from credentials" -a "list" -d 'List credential rows in the shared Convex pool'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l kind -d 'Credential kind (for Telegram v1, use telegram)'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l payload-file -d 'JSON object file containing the credential payload'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l repo-root -d 'Repository root for resolving relative payload-file paths'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l note -d 'Optional note stored with this credential row'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l site-url -d 'Override OPENCLAW_QA_CONVEX_SITE_URL'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l endpoint-prefix -d 'Override OPENCLAW_QA_CONVEX_ENDPOINT_PREFIX'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l actor-id -d 'Optional admin actor id to include in broker audit events'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l json -d 'Emit machine-readable JSON output'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l credential-id -d 'Credential row id from the Convex pool'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l site-url -d 'Override OPENCLAW_QA_CONVEX_SITE_URL'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l endpoint-prefix -d 'Override OPENCLAW_QA_CONVEX_ENDPOINT_PREFIX'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l actor-id -d 'Optional admin actor id to include in broker audit events'
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l json -d 'Emit machine-readable JSON output'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l kind -d 'Filter by credential kind'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l status -d 'Filter by row status: "active", "disabled", or "all"'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l limit -d 'Max rows to return'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l show-secrets -d 'Include credential payload JSON in output'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l site-url -d 'Override OPENCLAW_QA_CONVEX_SITE_URL'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l endpoint-prefix -d 'Override OPENCLAW_QA_CONVEX_ENDPOINT_PREFIX'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l actor-id -d 'Optional admin actor id to include in broker audit events'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Emit machine-readable JSON output'
